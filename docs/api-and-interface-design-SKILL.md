...
On data that just came from your own database 4. Prefer Addition Over Modification
...
Enum values UPPER_SNAKE "IN_PROGRESS", "COMPLETED" 6. Honouring an Idempotency Key
