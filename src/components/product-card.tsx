...
export function ProductCard({ product }: { product: ProductWithCategory }) {
  return (
    <Link
      ...
      className="hover-lift group block overflow-hidden rounded-lg border border-black/10 bg-white transition-all hover:-translate-y-0.5 hover:shadow-lg dark:border-white/15 dark:bg-white/5"
    >
